...
class PaymentSummaryViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource{
    ...
    func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        sectionView.views.backgroundColor = UIColor(red: 255.0/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0)
    ...
    func detailBtnPressed(sender:UIButton){
        ...
        SCLAlertView(appearance:appearance).showSuccess("Taxes/Fees", subTitle: newDetail, closeButtonTitle: "Close", colorStyle:0xFF0000, circleIconImage: alertViewIcon)
