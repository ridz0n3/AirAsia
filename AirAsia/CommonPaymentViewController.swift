...
class CommonPaymentViewController: BaseXLFormViewController {
    ...
    override func viewDidLoad() {
        ...
        creditCardCheckBox.strokeColor = UIColor.redColor()
        creditCardCheckBox.checkColor = UIColor.redColor()
        maybank2uCheckBox.strokeColor = UIColor.redColor()
        
        maybank2uCheckBox.checkColor = UIColor.redColor()
        cimbCheckBox.strokeColor = UIColor.redColor()
        cimbCheckBox.checkColor = UIColor.redColor()
        fpxCheckBox.strokeColor = UIColor.redColor()
        fpxCheckBox.checkColor = UIColor.redColor()
    ...
    func rearrangePaymentType(){
        ...
        var yonlinePosition : CGFloat = 215
        var countType1 = Int()
        var countType2 = Int()
        ...
        for channel in paymentType as! [Dictionary<String, AnyObject>]{
            ...
            if channel["channel_type"] as! Int == 1{
                ...
                let img = UIImageView(frame: CGRectMake(xchannelPosition, 150, 138, 62))
