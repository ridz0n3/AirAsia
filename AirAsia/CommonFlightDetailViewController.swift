    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        if flightDetail.count == 0{
            ...
            if flightDict!["flights"]?.count == 0{
                ...
                cell.checkFlight.strokeColor = UIColor.redColor()
                cell.checkFlight.checkColor = UIColor.redColor()
                if (planGoing == 1 && indexPath.section == 0) || (planReturn == 4 && indexPath.section == 1){
                    if flightBasic!["status"]!.string == "sold out"{
                        ...
                        //if flightBasic!["discount"]?.floatValue == 0{
                            ...
                            flightAvailable = true
                       /* }else{
                            cell.promoPriceLbl.text = String(format: "%.0f Pts", ((flightBasic!["total_fare"]?.floatValue)! * 1.5) + (flightBasic!["total_fare"]?.floatValue)!)
                            cell.priceLbl.text = String(format: "%.0f Pts", ((flightBasic!["before_discount_fare"]?.floatValue)! * 1.5) + (flightBasic!["total_fare"]?.floatValue)!)
