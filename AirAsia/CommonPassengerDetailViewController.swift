    ...
    override func tableView(tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        if try! LoginManager.sharedInstance.isLogin() && module == "addPassenger"{
            ...
            if index == 0{
                ...
                sectionView.familyButton.layer.borderColor = UIColor.redColor().CGColor
            ...
            sectionView.views.backgroundColor = UIColor(red: 255/255.0, green: 0/255.0, blue: 0/255.0, alpha: 1.0)
