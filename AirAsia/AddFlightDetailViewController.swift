...
class AddFlightDetailViewController: CommonFlightDetailViewController {
    ...
    override func viewDidLoad() {
        ...
        termCheckBox.strokeColor = UIColor.redColor()
        termCheckBox.checkColor = UIColor.redColor()
        ...
        AnalyticsManager.sharedInstance.logScreen(GAConstants.addFlightDetailScreen)
    ...
    func reloadAlertView(msg : String){
        ...
        alert.showEdit("Login", subTitle: msg, colorStyle: 0xFF0000, closeButtonTitle : "Close", circleIconImage: alertViewIcon)
