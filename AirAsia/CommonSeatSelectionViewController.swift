...
class CommonSeatSelectionViewController: BaseViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    func seatSelect(seatDetail: NSDictionary, btn: UIButton){
        ...
        messageView.showSuccess("Seat Selection", subTitle: "Seat : \(seatDetail["seat_number"] as! String)", colorStyle: 0xFF0000, closeButtonTitle: "Cancel", circleIconImage: alertViewIcon)
